...
const ContactUs = () => {
  return (
    <section
      id="contact"
      className="flex flex-col items-center gap-4 bg-indigo-500 py-10 text-center text-white"
    >
      <div className="flex w-1/3 flex-col gap-8 max-lg:w-3/4 max-sm:w-full">
